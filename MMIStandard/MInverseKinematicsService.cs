...
public partial class MInverseKinematicsService {
  public interface ISync : MMIServiceBase.ISync {
    MAvatarPostureValues ComputeIK(MAvatarPostureValues postureValues, List<MIKProperty> properties);
    MIKServiceResult CalculateIKPosture(MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_ComputeIK(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MIKProperty> properties);
    MAvatarPostureValues End_ComputeIK(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_CalculateIKPosture(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties);
  ...
  public class Client : MMIServiceBase.Client, Iface {
    ...
    public IAsyncResult Begin_ComputeIK(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MIKProperty> properties)
    {
      return send_ComputeIK(callback, state, postureValues, properties);
    }

    public MAvatarPostureValues End_ComputeIK(IAsyncResult asyncResult)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_ComputeIK(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MIKProperty> properties)
    {
    ...
    public void send_ComputeIK(MAvatarPostureValues postureValues, List<MIKProperty> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("ComputeIK", TMessageType.Call, seqid_));
      ComputeIK_args args = new ComputeIK_args();
      args.PostureValues = postureValues;
    ...
    public MAvatarPostureValues recv_ComputeIK()
    {
    ...
    public IAsyncResult Begin_CalculateIKPosture(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_CalculateIKPosture(AsyncCallback callback, object state, MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties)
    {
    ...
    public void send_CalculateIKPosture(MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("CalculateIKPosture", TMessageType.Call, seqid_));
      CalculateIKPosture_args args = new CalculateIKPosture_args();
      args.PostureValues = postureValues;
      ...
      try
      {
        ...
        if (Constraints != null && __isset.constraints) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (MConstraint _iter101 in Constraints)
            {
