...
public partial class MWalkPoint : TBase
{
  ...
  public MGeometryConstraint PositionConstraint { get; set; }
  ...
  public MWalkPoint(MGeometryConstraint PositionConstraint, double Suitability) : this() {
        ...
        switch (field.ID)
        {
          case 1:
            if (field.Type == TType.Struct) {
              PositionConstraint = new MGeometryConstraint();
