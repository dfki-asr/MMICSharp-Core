...
public partial class MotionModelUnit {
  public interface ISync {
    MBoolResponse Initialize(MAvatarDescription avatarDescription, Dictionary<string, string> properties);
    MBoolResponse AssignInstruction(MInstruction motionInstruction, MSimulationState simulationState);
    ...
    MBoolResponse Abort(string instructionId);
    MBoolResponse Dispose(string avatarID, Dictionary<string, string> parameters);
    byte[] CreateCheckpoint(string avatarID);
    MBoolResponse RestoreCheckpoint(byte[] data, string avatarID);
    Dictionary<string, string> ExecuteFunction(string name, string avatarID, Dictionary<string, string> parameters);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_Initialize(AsyncCallback callback, object state, MAvatarDescription avatarDescription, Dictionary<string, string> properties);
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_Dispose(AsyncCallback callback, object state, string avatarID, Dictionary<string, string> parameters);
    MBoolResponse End_Dispose(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_CreateCheckpoint(AsyncCallback callback, object state, string avatarID);
    byte[] End_CreateCheckpoint(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_RestoreCheckpoint(AsyncCallback callback, object state, byte[] data, string avatarID);
    MBoolResponse End_RestoreCheckpoint(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_ExecuteFunction(AsyncCallback callback, object state, string name, string avatarID, Dictionary<string, string> parameters);
  ...
  public class Client : IDisposable, Iface {
    ...
    public IAsyncResult Begin_Initialize(AsyncCallback callback, object state, MAvatarDescription avatarDescription, Dictionary<string, string> properties)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_Initialize(AsyncCallback callback, object state, MAvatarDescription avatarDescription, Dictionary<string, string> properties)
    {
    ...
    public void send_Initialize(MAvatarDescription avatarDescription, Dictionary<string, string> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("Initialize", TMessageType.Call, seqid_));
      Initialize_args args = new Initialize_args();
      args.AvatarDescription = avatarDescription;
    ...
    public MBoolResponse AssignInstruction(MInstruction motionInstruction, MSimulationState simulationState)
    {
      #if SILVERLIGHT
    ...
    public IAsyncResult Begin_Dispose(AsyncCallback callback, object state, string avatarID, Dictionary<string, string> parameters)
    {
      return send_Dispose(callback, state, avatarID, parameters);
    }
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_Dispose(null, null, avatarID, parameters);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_Dispose(AsyncCallback callback, object state, string avatarID, Dictionary<string, string> parameters)
    {
    ...
    public void send_Dispose(string avatarID, Dictionary<string, string> parameters)
    {
      oprot_.WriteMessageBegin(new TMessage("Dispose", TMessageType.Call, seqid_));
      Dispose_args args = new Dispose_args();
      args.AvatarID = avatarID;
    ...
    public IAsyncResult Begin_CreateCheckpoint(AsyncCallback callback, object state, string avatarID)
    {
      return send_CreateCheckpoint(callback, state, avatarID);
    }
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_CreateCheckpoint(null, null, avatarID);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_CreateCheckpoint(AsyncCallback callback, object state, string avatarID)
    {
    ...
    public void send_CreateCheckpoint(string avatarID)
    {
      oprot_.WriteMessageBegin(new TMessage("CreateCheckpoint", TMessageType.Call, seqid_));
      CreateCheckpoint_args args = new CreateCheckpoint_args();
      args.AvatarID = avatarID;
    ...
    public IAsyncResult Begin_RestoreCheckpoint(AsyncCallback callback, object state, byte[] data, string avatarID)
    {
      return send_RestoreCheckpoint(callback, state, data, avatarID);
    }
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_RestoreCheckpoint(null, null, data, avatarID);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_RestoreCheckpoint(AsyncCallback callback, object state, byte[] data, string avatarID)
    {
    ...
    public void send_RestoreCheckpoint(byte[] data, string avatarID)
    {
      oprot_.WriteMessageBegin(new TMessage("RestoreCheckpoint", TMessageType.Call, seqid_));
      RestoreCheckpoint_args args = new RestoreCheckpoint_args();
      args.Data = data;
    ...
    public IAsyncResult Begin_ExecuteFunction(AsyncCallback callback, object state, string name, string avatarID, Dictionary<string, string> parameters)
    {
      return send_ExecuteFunction(callback, state, name, avatarID, parameters);
    }
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_ExecuteFunction(null, null, name, avatarID, parameters);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_ExecuteFunction(AsyncCallback callback, object state, string name, string avatarID, Dictionary<string, string> parameters)
    {
    ...
    public void send_ExecuteFunction(string name, string avatarID, Dictionary<string, string> parameters)
    {
      oprot_.WriteMessageBegin(new TMessage("ExecuteFunction", TMessageType.Call, seqid_));
      ExecuteFunction_args args = new ExecuteFunction_args();
      args.Name = name;
  ...
  public class Processor : TProcessor {
    ...
    public void Dispose_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.Dispose(args.AvatarID, args.Parameters);
    ...
    public void CreateCheckpoint_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.CreateCheckpoint(args.AvatarID);
    ...
    public void RestoreCheckpoint_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.RestoreCheckpoint(args.Data, args.AvatarID);
    ...
    public void ExecuteFunction_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.ExecuteFunction(args.Name, args.AvatarID, args.Parameters);
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (MConstraint _iter87 in Success)
              {
                _iter87.Write(oprot);
              }
              oprot.WriteListEnd();
