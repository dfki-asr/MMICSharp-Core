...
public partial class MCoSimulationEvents : TBase
{
  ...
  public List<MSimulationEvent> Events { get; set; }
  ...
  public MCoSimulationEvents(List<MSimulationEvent> Events, double SimulationTime, int FrameNumber) : this() {
    this.Events = Events;
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  MSimulationEvent _elem2;
                  _elem2 = new MSimulationEvent();
                  _elem2.Read(iprot);
                  Events.Add(_elem2);
                }
                iprot.ReadListEnd();
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (MSimulationEvent _iter3 in Events)
        {
          _iter3.Write(oprot);
        }
        oprot.WriteListEnd();
