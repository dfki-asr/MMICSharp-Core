...
public partial class MBlendingService {
  public interface ISync : MMIServiceBase.ISync {
    MBoolResponse SetBlendingMask(Dictionary<MJointType, double> mask, string avatarID);
    MAvatarPostureValues Blend(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_SetBlendingMask(AsyncCallback callback, object state, Dictionary<MJointType, double> mask, string avatarID);
    MBoolResponse End_SetBlendingMask(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight);
  ...
  public class Client : MMIServiceBase.Client, Iface {
    ...
    public IAsyncResult Begin_SetBlendingMask(AsyncCallback callback, object state, Dictionary<MJointType, double> mask, string avatarID)
    {
      return send_SetBlendingMask(callback, state, mask, avatarID);
    }

    public MBoolResponse End_SetBlendingMask(IAsyncResult asyncResult)
    {
    ...
    public MBoolResponse SetBlendingMask(Dictionary<MJointType, double> mask, string avatarID)
    {
      #if SILVERLIGHT
    ...
    #if SILVERLIGHT
    public IAsyncResult send_SetBlendingMask(AsyncCallback callback, object state, Dictionary<MJointType, double> mask, string avatarID)
    {
    ...
    public void send_SetBlendingMask(Dictionary<MJointType, double> mask, string avatarID)
    {
      oprot_.WriteMessageBegin(new TMessage("SetBlendingMask", TMessageType.Call, seqid_));
      SetBlendingMask_args args = new SetBlendingMask_args();
      args.Mask = mask;
    ...
    public MBoolResponse recv_SetBlendingMask()
    {
    ...
    public IAsyncResult Begin_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight)
    {
    ...
    public MAvatarPostureValues Blend(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight)
    {
      #if SILVERLIGHT
    ...
    #if SILVERLIGHT
    public IAsyncResult send_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight)
    {
    ...
    public void send_Blend(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight)
    {
      oprot_.WriteMessageBegin(new TMessage("Blend", TMessageType.Call, seqid_));
      Blend_args args = new Blend_args();
      args.StartPosture = startPosture;
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i104 = 0; _i104 < _map103.Count; ++_i104)
                  {
                    MJointType _key105;
                    double _val106;
                    _key105 = (MJointType)iprot.ReadI32();
      ...
      try
      {
        ...
        if (Mask != null && __isset.mask) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (MJointType _iter107 in Mask.Keys)
            {
