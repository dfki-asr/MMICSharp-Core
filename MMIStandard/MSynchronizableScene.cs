...
public partial class MSynchronizableScene {
  public interface ISync : MMIServiceBase.ISync {
    MBoolResponse ApplyUpdates(MSceneUpdate sceneUpdates);
    MBoolResponse ApplyManipulations(List<MSceneManipulation> sceneManipulations);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_ApplyUpdates(AsyncCallback callback, object state, MSceneUpdate sceneUpdates);
    MBoolResponse End_ApplyUpdates(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_ApplyManipulations(AsyncCallback callback, object state, List<MSceneManipulation> sceneManipulations);
    MBoolResponse End_ApplyManipulations(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : MMIServiceBase.Client, Iface {
    ...
    public IAsyncResult Begin_ApplyUpdates(AsyncCallback callback, object state, MSceneUpdate sceneUpdates)
    {
      return send_ApplyUpdates(callback, state, sceneUpdates);
    }

    public MBoolResponse End_ApplyUpdates(IAsyncResult asyncResult)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_ApplyUpdates(AsyncCallback callback, object state, MSceneUpdate sceneUpdates)
    {
    ...
    public void send_ApplyUpdates(MSceneUpdate sceneUpdates)
    {
      oprot_.WriteMessageBegin(new TMessage("ApplyUpdates", TMessageType.Call, seqid_));
      ApplyUpdates_args args = new ApplyUpdates_args();
      args.SceneUpdates = sceneUpdates;
    ...
    public MBoolResponse recv_ApplyUpdates()
    {
    ...
    public IAsyncResult Begin_ApplyManipulations(AsyncCallback callback, object state, List<MSceneManipulation> sceneManipulations)
    {
      return send_ApplyManipulations(callback, state, sceneManipulations);
    }

    public MBoolResponse End_ApplyManipulations(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_ApplyManipulations(AsyncCallback callback, object state, List<MSceneManipulation> sceneManipulations)
    {
    ...
    public void send_ApplyManipulations(List<MSceneManipulation> sceneManipulations)
    {
      oprot_.WriteMessageBegin(new TMessage("ApplyManipulations", TMessageType.Call, seqid_));
      ApplyManipulations_args args = new ApplyManipulations_args();
      args.SceneManipulations = sceneManipulations;
    ...
    public MBoolResponse recv_ApplyManipulations()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
