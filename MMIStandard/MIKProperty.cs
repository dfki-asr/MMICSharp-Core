...
public partial class MIKProperty : TBase
{
  ...
  /// <summary>
  /// 
  /// <seealso cref=".MEndeffectorType"/>
  /// </summary>
  public MEndeffectorType Target { get; set; }
  ...
  public MIKProperty(List<double> Values, double Weight, MEndeffectorType Target, MIKOperationType OperationType) : this() {
    this.Values = Values;
    this.Weight = Weight;
    this.Target = Target;
        ...
        switch (field.ID)
        {
          ...
          case 3:
            if (field.Type == TType.I32) {
              Target = (MEndeffectorType)iprot.ReadI32();
              isset_Target = true;
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
