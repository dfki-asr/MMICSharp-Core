...
{
  private List<MConstraint> _Prerequisites;
  ...
  private List<MParameter> _SceneParameters;
  ...
  public List<MConstraint> Prerequisites
  {
    get
    {
  ...
  public List<MParameter> SceneParameters
  {
    get
    {
        ...
        switch (field.ID)
        {
          ...
          case 9:
            if (field.Type == TType.List) {
              {
                Prerequisites = new List<MConstraint>();
                TList _list41 = iprot.ReadListBegin();
                for( int _i42 = 0; _i42 < _list41.Count; ++_i42)
                {
                  MConstraint _elem43;
                  _elem43 = new MConstraint();
                  _elem43.Read(iprot);
    ...
    try
    {
      ...
      if (Prerequisites != null && __isset.Prerequisites) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MConstraint _iter60 in Prerequisites)
          {
            _iter60.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (Parameters != null && __isset.Parameters) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MParameter _iter64 in Parameters)
          {
            _iter64.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (SceneParameters != null && __isset.SceneParameters) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MParameter _iter65 in SceneParameters)
          {
            _iter65.Write(oprot);
          }
          oprot.WriteListEnd();
