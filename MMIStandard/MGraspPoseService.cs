...
public partial class MGraspPoseService {
  public interface ISync : MMIServiceBase.ISync {
    List<MGeometryConstraint> GetGraspPoses(MAvatarPostureValues posture, MJointType handType, MSceneObject sceneObject, bool repositionHand);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_GetGraspPoses(AsyncCallback callback, object state, MAvatarPostureValues posture, MJointType handType, MSceneObject sceneObject, bool repositionHand);
    List<MGeometryConstraint> End_GetGraspPoses(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : MMIServiceBase.Client, Iface {
    ...
    public IAsyncResult Begin_GetGraspPoses(AsyncCallback callback, object state, MAvatarPostureValues posture, MJointType handType, MSceneObject sceneObject, bool repositionHand)
    {
      return send_GetGraspPoses(callback, state, posture, handType, sceneObject, repositionHand);
    }

    public List<MGeometryConstraint> End_GetGraspPoses(IAsyncResult asyncResult)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_GetGraspPoses(AsyncCallback callback, object state, MAvatarPostureValues posture, MJointType handType, MSceneObject sceneObject, bool repositionHand)
    {
    ...
    public void send_GetGraspPoses(MAvatarPostureValues posture, MJointType handType, MSceneObject sceneObject, bool repositionHand)
    {
      oprot_.WriteMessageBegin(new TMessage("GetGraspPoses", TMessageType.Call, seqid_));
      GetGraspPoses_args args = new GetGraspPoses_args();
      args.Posture = posture;
    ...
    public List<MGeometryConstraint> recv_GetGraspPoses()
    {
  ...
  {
    private MAvatarPostureValues _posture;
    private MJointType _handType;
    private MSceneObject _sceneObject;
    private bool _repositionHand;

    public MAvatarPostureValues Posture
    {
      get
      {
        return _posture;
          ...
          switch (field.ID)
          {
            ...
            case 2:
              if (field.Type == TType.I32) {
                HandType = (MJointType)iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
  ...
  {
    private List<MGeometryConstraint> _success;

    public List<MGeometryConstraint> Success
    {
      get
      {
        return _success;
