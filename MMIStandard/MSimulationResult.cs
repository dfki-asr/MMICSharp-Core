...
public partial class MSimulationResult : TBase
{
  ...
  private List<MDrawingCall> _DrawingCalls;
  ...
  public List<MDrawingCall> DrawingCalls
  {
    get
    {
  ...
  public MSimulationResult(MAvatarPostureValues Posture) : this() {
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  MSceneManipulation _elem20;
                  _elem20 = new MSceneManipulation();
                  _elem20.Read(iprot);
            ...
            if (field.Type == TType.List) {
              {
                ...
                {
                  MDrawingCall _elem23;
                  _elem23 = new MDrawingCall();
                  _elem23.Read(iprot);
    ...
    try
    {
      ...
      if (Constraints != null && __isset.Constraints) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MConstraint _iter27 in Constraints)
          {
            _iter27.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (SceneManipulations != null && __isset.SceneManipulations) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MSceneManipulation _iter29 in SceneManipulations)
          {
            _iter29.Write(oprot);
          }
          oprot.WriteListEnd();
      ...
      if (DrawingCalls != null && __isset.DrawingCalls) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MDrawingCall _iter30 in DrawingCalls)
          {
            _iter30.Write(oprot);
          }
          oprot.WriteListEnd();
