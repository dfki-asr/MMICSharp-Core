...
public partial class MMIRegisterService {
  public interface ISync {
    ...
    List<MServiceDescription> GetRegisteredServices(string sessionID);
    Dictionary<MMUDescription, List<MIPAddress>> GetAvailableMMUs(string sessionID);
    MBoolResponse RegisterAdapter(MAdapterDescription adapterDescription);
    MBoolResponse UnregisterAdapter(MAdapterDescription adapterDescription);
    MBoolResponse RegisterService(MServiceDescription serviceDescription);
    MBoolResponse UnregisterService(MServiceDescription serviceDescription);
  ...
  public interface Iface : ISync {
    ...
    List<MServiceDescription> End_GetRegisteredServices(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_GetAvailableMMUs(AsyncCallback callback, object state, string sessionID);
    Dictionary<MMUDescription, List<MIPAddress>> End_GetAvailableMMUs(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_RegisterAdapter(AsyncCallback callback, object state, MAdapterDescription adapterDescription);
    MBoolResponse End_RegisterAdapter(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_UnregisterAdapter(AsyncCallback callback, object state, MAdapterDescription adapterDescription);
    MBoolResponse End_UnregisterAdapter(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_RegisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription);
    MBoolResponse End_RegisterService(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_UnregisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription);
    MBoolResponse End_UnregisterService(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
  ...
  public class Client : IDisposable, Iface {
    ...
    public List<MServiceDescription> End_GetRegisteredServices(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public List<MServiceDescription> GetRegisteredServices(string sessionID)
    {
      #if SILVERLIGHT
    ...
    public List<MServiceDescription> recv_GetRegisteredServices()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public Dictionary<MMUDescription, List<MIPAddress>> End_GetAvailableMMUs(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public Dictionary<MMUDescription, List<MIPAddress>> GetAvailableMMUs(string sessionID)
    {
      #if SILVERLIGHT
    ...
    public Dictionary<MMUDescription, List<MIPAddress>> recv_GetAvailableMMUs()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public MBoolResponse End_RegisterAdapter(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public MBoolResponse RegisterAdapter(MAdapterDescription adapterDescription)
    {
      #if SILVERLIGHT
    ...
    public MBoolResponse recv_RegisterAdapter()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public MBoolResponse End_UnregisterAdapter(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public MBoolResponse recv_UnregisterAdapter()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public IAsyncResult Begin_RegisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription)
    {
      return send_RegisterService(callback, state, serviceDescription);
    }

    public MBoolResponse End_RegisterService(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_RegisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription)
    {
    ...
    public void send_RegisterService(MServiceDescription serviceDescription)
    {
      oprot_.WriteMessageBegin(new TMessage("RegisterService", TMessageType.Call, seqid_));
      RegisterService_args args = new RegisterService_args();
      args.ServiceDescription = serviceDescription;
    ...
    public MBoolResponse recv_RegisterService()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public IAsyncResult Begin_UnregisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription)
    {
      return send_UnregisterService(callback, state, serviceDescription);
    }

    public MBoolResponse End_UnregisterService(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_UnregisterService(AsyncCallback callback, object state, MServiceDescription serviceDescription)
    {
    ...
    public void send_UnregisterService(MServiceDescription serviceDescription)
    {
      oprot_.WriteMessageBegin(new TMessage("UnregisterService", TMessageType.Call, seqid_));
      UnregisterService_args args = new UnregisterService_args();
      args.ServiceDescription = serviceDescription;
    ...
    public MBoolResponse recv_UnregisterService()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
  ...
  {
    private List<MServiceDescription> _success;

    public List<MServiceDescription> Success
    {
      get
      {
        return _success;
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.List) {
                {
                  Success = new List<MServiceDescription>();
                  TList _list62 = iprot.ReadListBegin();
                  for( int _i63 = 0; _i63 < _list62.Count; ++_i63)
                  {
                    MServiceDescription _elem64;
                    _elem64 = new MServiceDescription();
                    _elem64.Read(iprot);
                    Success.Add(_elem64);
                  }
                  iprot.ReadListEnd();
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (MServiceDescription _iter65 in Success)
              {
                _iter65.Write(oprot);
              }
              oprot.WriteListEnd();
  ...
  {
    private Dictionary<MMUDescription, List<MIPAddress>> _success;

    public Dictionary<MMUDescription, List<MIPAddress>> Success
    {
      get
      {
        return _success;
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.Map) {
                {
                  Success = new Dictionary<MMUDescription, List<MIPAddress>>();
                  TMap _map66 = iprot.ReadMapBegin();
                  for( int _i67 = 0; _i67 < _map66.Count; ++_i67)
                  {
                    MMUDescription _key68;
                    List<MIPAddress> _val69;
                    _key68 = new MMUDescription();
                    _key68.Read(iprot);
                    {
                      _val69 = new List<MIPAddress>();
                      TList _list70 = iprot.ReadListBegin();
                      for( int _i71 = 0; _i71 < _list70.Count; ++_i71)
                      {
                        MIPAddress _elem72;
                        _elem72 = new MIPAddress();
                        _elem72.Read(iprot);
                        _val69.Add(_elem72);
                      }
                      iprot.ReadListEnd();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (MMUDescription _iter73 in Success.Keys)
              {
                _iter73.Write(oprot);
                {
                  oprot.WriteListBegin(new TList(TType.Struct, Success[_iter73].Count));
                  foreach (MIPAddress _iter74 in Success[_iter73])
                  {
                    _iter74.Write(oprot);
                  }
                  oprot.WriteListEnd();
  ...
  {
    private MServiceDescription _serviceDescription;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.Struct) {
                ServiceDescription = new MServiceDescription();
