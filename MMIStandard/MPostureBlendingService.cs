...
public partial class MPostureBlendingService {
  public interface ISync : MMIServiceBase.ISync {
    MAvatarPostureValues Blend(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight, Dictionary<MJointType, double> mask, Dictionary<string, string> properties);
    List<MAvatarPostureValues> BlendMany(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, List<double> weights, Dictionary<MJointType, double> mask, Dictionary<string, string> properties);
  }

  public interface Iface : ISync {
    #if SILVERLIGHT
    IAsyncResult Begin_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight, Dictionary<MJointType, double> mask, Dictionary<string, string> properties);
    MAvatarPostureValues End_Blend(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_BlendMany(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, List<double> weights, Dictionary<MJointType, double> mask, Dictionary<string, string> properties);
    List<MAvatarPostureValues> End_BlendMany(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : MMIServiceBase.Client, Iface {
    ...
    public IAsyncResult Begin_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
      return send_Blend(callback, state, startPosture, targetPosture, weight, mask, properties);
    }

    public MAvatarPostureValues End_Blend(IAsyncResult asyncResult)
    {
    ...
    #if SILVERLIGHT
    public IAsyncResult send_Blend(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
    ...
    public void send_Blend(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, double weight, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("Blend", TMessageType.Call, seqid_));
      Blend_args args = new Blend_args();
      args.StartPosture = startPosture;
    ...
    public MAvatarPostureValues recv_Blend()
    {
    ...
    public IAsyncResult Begin_BlendMany(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, List<double> weights, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
      return send_BlendMany(callback, state, startPosture, targetPosture, weights, mask, properties);
    }

    public List<MAvatarPostureValues> End_BlendMany(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_BlendMany(AsyncCallback callback, object state, MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, List<double> weights, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
    ...
    public void send_BlendMany(MAvatarPostureValues startPosture, MAvatarPostureValues targetPosture, List<double> weights, Dictionary<MJointType, double> mask, Dictionary<string, string> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("BlendMany", TMessageType.Call, seqid_));
      BlendMany_args args = new BlendMany_args();
      args.StartPosture = startPosture;
    ...
    public List<MAvatarPostureValues> recv_BlendMany()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
  ...
  {
    private MAvatarPostureValues _startPosture;
    private MAvatarPostureValues _targetPosture;
    private double _weight;
    private Dictionary<MJointType, double> _mask;
    private Dictionary<string, string> _properties;

    public MAvatarPostureValues StartPosture
    {
      get
      {
    ...
    public MAvatarPostureValues TargetPosture
    {
      get
      {
    ...
    public Dictionary<MJointType, double> Mask
    {
      get
      {
        return _mask;
          ...
          switch (field.ID)
          {
            case 1:
              if (field.Type == TType.Struct) {
                StartPosture = new MAvatarPostureValues();
            ...
            case 2:
              if (field.Type == TType.Struct) {
                TargetPosture = new MAvatarPostureValues();
      ...
      try
      {
        ...
        if (Mask != null && __isset.mask) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (MJointType _iter116 in Mask.Keys)
            {
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i122 = 0; _i122 < _map121.Count; ++_i122)
                  {
                    MJointType _key123;
                    double _val124;
                    _key123 = (MJointType)iprot.ReadI32();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mask != null && __isset.mask) {
          ...
          {
            oprot.WriteMapBegin(new TMap(TType.I32, TType.Double, Mask.Count));
            foreach (MJointType _iter130 in Mask.Keys)
            {
              ...
              if (field.Type == TType.List) {
                {
                  ...
                  {
                    MAvatarPostureValues _elem134;
                    _elem134 = new MAvatarPostureValues();
                    _elem134.Read(iprot);
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (MAvatarPostureValues _iter135 in Success)
              {
