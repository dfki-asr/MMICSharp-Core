...
public partial class MMIServiceBase {
  public interface ISync {
    ...
    MBoolResponse Setup(MAvatarDescription avatar, Dictionary<string, string> properties);
    Dictionary<string, string> Consume(Dictionary<string, string> properties);
    MBoolResponse Dispose(Dictionary<string, string> properties);
    MBoolResponse Restart(Dictionary<string, string> properties);
  }
  ...
  public interface Iface : ISync {
    ...
    MServiceDescription End_GetDescription(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_Setup(AsyncCallback callback, object state, MAvatarDescription avatar, Dictionary<string, string> properties);
    MBoolResponse End_Setup(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
    ...
    MBoolResponse End_Restart(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : IDisposable, Iface {
    ...
    public MServiceDescription End_GetDescription(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public MServiceDescription recv_GetDescription()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public IAsyncResult Begin_Setup(AsyncCallback callback, object state, MAvatarDescription avatar, Dictionary<string, string> properties)
    {
      return send_Setup(callback, state, avatar, properties);
    }

    public MBoolResponse End_Setup(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_Setup();
    }
    ...
    #if SILVERLIGHT
    public IAsyncResult send_Setup(AsyncCallback callback, object state, MAvatarDescription avatar, Dictionary<string, string> properties)
    {
    ...
    public void send_Setup(MAvatarDescription avatar, Dictionary<string, string> properties)
    {
      oprot_.WriteMessageBegin(new TMessage("Setup", TMessageType.Call, seqid_));
      Setup_args args = new Setup_args();
      args.Avatar = avatar;
    ...
    public MBoolResponse recv_Setup()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
    ...
    public MBoolResponse End_Restart(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
      return recv_Restart();
    }
    ...
    public MBoolResponse recv_Restart()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
  ...
  {
    private MServiceDescription _success;

    public MServiceDescription Success
    {
      get
      {
        return _success;
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.Struct) {
                Success = new MServiceDescription();
                Success.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
  ...
  {
    private MAvatarDescription _avatar;
    private Dictionary<string, string> _properties;

    public MAvatarDescription Avatar
    {
      get
      {
        return _avatar;
