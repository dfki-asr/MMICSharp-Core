...
public partial class MAccelerationConstraint : TBase
{
  ...
  private MVector3 _TranslationalAcceleration;
  private MVector3 _RotationalAcceleration;
  ...
  public MVector3 TranslationalAcceleration
  {
    get
    {
  ...
  public MVector3 RotationalAcceleration
  {
    get
    {
    ...
    try
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 3:
            if (field.Type == TType.Struct) {
              TranslationalAcceleration = new MVector3();
          ...
          case 4:
            if (field.Type == TType.Struct) {
              RotationalAcceleration = new MVector3();
