...
public partial class MAdapterDescription : TBase
{
  ...
  public MAdapterDescription(string Name, string ID, string Language, List<MIPAddress> Addresses) : this() {
    this.Name = Name;
    this.ID = ID;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (MIPAddress _iter10 in Addresses)
        {
          _iter10.Write(oprot);
        }
        oprot.WriteListEnd();
      ...
      if (Parameters != null && __isset.Parameters) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (MParameter _iter12 in Parameters)
          {
            _iter12.Write(oprot);
          }
          oprot.WriteListEnd();
