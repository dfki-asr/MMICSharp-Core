        ...
        private void HandleRegistration()
        {
            while (!this.cts.IsCancellationRequested)
            {
                ...
                if (!RegistrationAvailable(description))
                {
                    ...
                    {
                        Logger.Log(Log_level.L_ERROR, $"Error checking service registration for {this.description.Name} on {this.address}!");
                    }
                } else
                {
                    Logger.Log(Log_level.L_INFO, "Registration already available");
