...
namespace MMICSharp.Common
{
    ...
    public class RetargetingService : MRetargetingService.Iface
    {
        ...
        {
            Logger.Log(Log_level.L_INFO, "Start Service at port" + port.ToString());
        ...
        public MAvatarDescription SetupRetargeting(MAvatarPosture globalTarget)
        {
            ...
            if(joint_map.Count < 5)
            {
                ...
                Logger.Log(Log_level.L_DEBUG, "Warning. joint map size smaller than 5. Please check your retargeting configuration.");
                Logger.Log(Log_level.L_DEBUG, "   provided Target Posture: " + MMICSharp.Common.Communication.Serialization.ToJsonString<MAvatarPosture>(globalTarget));
                Logger.Log(Log_level.L_DEBUG, "   joint map (lenght: " + joint_map.Count + "): " + string.Join(", ", joint_map));
            ...
            {
                Logger.Log(Log_level.L_DEBUG, "Warning: Skeleton alread existing under ID " + id);
            ...
            } catch(System.Collections.Generic.KeyNotFoundException e)
            {
                var ff = Console.ForegroundColor;
                Console.ForegroundColor = ConsoleColor.Yellow;
                Logger.Log(Log_level.L_DEBUG, "Access error during skeleton scaling.");
                Logger.Log(Log_level.L_DEBUG, "   provided Target Posture: " + MMICSharp.Common.Communication.Serialization.ToJsonString<MAvatarPosture>(globalTarget));
                Logger.Log(Log_level.L_DEBUG, "   joint map (lenght: " + joint_map.Count + "): " + string.Join(", ", joint_map));
                Console.ForegroundColor = ff;
