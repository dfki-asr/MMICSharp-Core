...
namespace MMIStandard
{
    ...
    public static class MVector3Extensions
    {
		...
		/// </summary>
		public static float SqMagnitude(this MVector3 vector)
		{
		...
		/// </summary>
		public static double SqDistance(MVector3 vector1, MVector3 vector2)
		{
			return vector1.Subtract(vector2).SqMagnitude();
		}
